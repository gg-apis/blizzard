...
class AmpMythicKeystoneCharacterApiFetchCharacterProfileTest extends BlizzardProfileApiTestCase {
    ...
    protected function assertResourceIsValid(object $resource) : void {
        ...
        self::assertSame(163, $resource->rating->color->r);
        self::assertSame(53, $resource->rating->color->g);
        self::assertSame(238, $resource->rating->color->b);
        self::assertSame(1.0, $resource->rating->color->a);
        self::assertSame(897, $resource->currentPeriodId);
        self::assertSame([9, 8], $resource->seasonIds);
    }
}
